...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard - ThriftMotors')</title>
    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-white dark:bg-gray-800 border-b border-transparent dark:border-gray-700 shadow-sm h-16 flex items-center px-4 md:px-8 transition-colors duration-200">
                ...
                <h2 class="text-xl font-semibold dark:text-white truncate">@yield('page-title', 'Dashboard')</h2>
                ...
                <div class="ml-auto flex items-center space-x-4">
                    ...
                    <a href="{{ route('home') }}" class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hidden sm:block">
