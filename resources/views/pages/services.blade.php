...
@section('title', 'Our Services - ThriftMotors')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-transparent dark:border-gray-700 transition transform hover:-translate-y-1 hover:shadow-xl dark:hover:shadow-red-900/20">
            ...
            <div class="p-8 text-center">
                ...
                <a href="{{ route('cars.index') }}" class="inline-block bg-red-600 text-white font-bold py-3 px-8 rounded-full hover:bg-red-700 transition">
                    View Cars for Sale
                </a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-transparent dark:border-gray-700 transition transform hover:-translate-y-1 hover:shadow-xl dark:hover:shadow-red-900/20">
            ...
            <div class="p-8 text-center">
                ...
                <a href="{{ route('cars.hire') }}" class="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-full hover:bg-blue-700 transition">
                    View Cars for Hire
                </a>
            </div>
        </div>
