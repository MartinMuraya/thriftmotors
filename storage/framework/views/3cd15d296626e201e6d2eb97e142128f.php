    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 text-gray-700 dark:text-white transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:flex md:flex-col">
            ...
            <nav class="flex-1 px-4 space-y-2 overflow-y-auto pt-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-chart-line mr-2 w-5"></i> Dashboard
                </a>
                <a href="<?php echo e(route('admin.cars.index')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.cars.index') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-car mr-2 w-5"></i> Manage Cars
                </a>
                <a href="<?php echo e(route('admin.cars.create')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.cars.create') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-plus mr-2 w-5"></i> Add New Car
                </a>
                <a href="<?php echo e(route('admin.inquiries.index')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.inquiries.*') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-envelope mr-2 w-5"></i> Inquiries
                    <?php $unread = \App\Models\Inquiry::where('is_read', false)->count(); ?>
                    <?php if($unread > 0): ?>
                        <span class="ml-2 bg-red-600 text-white text-xs px-2 py-0.5 rounded-full"><?php echo e($unread); ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?php echo e(route('admin.reservations.index')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.reservations.*') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-key mr-2 w-5"></i> Reservations
                    <?php $pendingRes = \App\Models\Reservation::where('status', 'pending')->count(); ?>
                    <?php if($pendingRes > 0): ?>
                        <span class="ml-2 bg-orange-500 text-white text-xs px-2 py-0.5 rounded-full"><?php echo e($pendingRes); ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?php echo e(route('admin.about.index')); ?>" class="block px-4 py-2 rounded-lg transition <?php echo e(request()->routeIs('admin.about.*') ? 'bg-red-50 dark:bg-gray-800 text-red-600 dark:text-red-500 font-bold' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300'); ?>">
                    <i class="fas fa-info-circle mr-2 w-5"></i> Manage About Us
                </a>
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-2 rounded-lg transition md:hidden hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300">
