    ...
    <nav class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-md border-b border-transparent dark:border-gray-700 transition-colors duration-200" x-data="{ mobileMenuOpen: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo e(route('cars.index')); ?>" class="py-5 hover:text-red-600 dark:hover:text-red-400 transition <?php echo e(request()->routeIs('cars.index') ? 'border-b-2 border-red-600 text-red-600 dark:text-red-400 dark:border-red-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">Buy a Car</a>
                    <a href="<?php echo e(route('cars.hire')); ?>" class="py-5 hover:text-red-600 dark:hover:text-red-400 transition <?php echo e(request()->routeIs('cars.hire') ? 'border-b-2 border-red-600 text-red-600 dark:text-red-400 dark:border-red-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">Hire a Car</a>
                    <a href="<?php echo e(route('services')); ?>" class="py-5 hover:text-red-600 dark:hover:text-red-400 transition <?php echo e(request()->routeIs('services') ? 'border-b-2 border-red-600 text-red-600 dark:text-red-400 dark:border-red-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">Services</a>
        ...
        <div x-show="mobileMenuOpen" x-collapse x-cloak class="md:hidden bg-white dark:bg-gray-800 border-t dark:border-gray-700">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="<?php echo e(route('cars.index')); ?>" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->routeIs('cars.index') ? 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'); ?>">Buy a Car</a>
                <a href="<?php echo e(route('cars.hire')); ?>" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->routeIs('cars.hire') ? 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'); ?>">Hire a Car</a>
                <a href="<?php echo e(route('services')); ?>" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->routeIs('services') ? 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'); ?>">Services</a>
