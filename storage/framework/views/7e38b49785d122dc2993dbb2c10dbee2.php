        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 dark:text-gray-500 text-sm">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="<?php echo e(route('privacy')); ?>" class="hover:text-red-600 dark:hover:text-red-400 transition">Privacy Policy</a>
                    <a href="<?php echo e(route('terms')); ?>" class="hover:text-red-600 dark:hover:text-red-400 transition">Terms of Service</a>
                </div>
            </div>
        </div>
    </footer>
