<?php $__env->startSection('title', 'About Us - ThriftMotors'); ?>
...
<div class="bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="relative min-h-[60vh] flex items-center overflow-hidden bg-gray-900">
        <?php if($slides->count() > 0): ?>
            ...
            <div x-data="{ 
                active: 0, 
                slides: <?php echo e($slides->map(fn($s) => asset('storage/'.$s->image_path))); ?>,
        ...
        <?php else: ?>
            <div class="absolute inset-0 opacity-40">
                <img src="<?php echo e($content->hero_bg_image ? asset('storage/'.$content->hero_bg_image) : 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&q=80&w=2000'); ?>" class="w-full h-full object-cover">
            </div>
        <?php endif; ?>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6">
                <?php echo e($content->hero_title); ?>

            </h1>
            <p class="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                <?php echo e($content->hero_description); ?>
    ...
    <div class="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
                <h2 class="text-3xl font-bold dark:text-white mb-6 border-l-4 border-red-600 pl-4"><?php echo e($content->mission_title ?? 'Our Mission'); ?></h2>
                <p class="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-10">
                    <?php echo e($content->mission_description ?? 'To simplify the car buying and hiring process by providing a secure, transparent, and user-centric platform that connects quality vehicles with happy owners.'); ?>

                </p>

                <h2 class="text-3xl font-bold dark:text-white mb-6 border-l-4 border-red-600 pl-4"><?php echo e($content->vision_title ?? 'Our Vision'); ?></h2>
                <p class="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-6">
                    <?php echo e($content->vision_description ?? 'To be the most trusted automotive marketplace in East Africa, setting the standard for digital car transactions and customer satisfaction.'); ?>

                </p>
            </div>
            <div class="relative">
                <img src="<?php echo e($content->mission_image ? asset('storage/'.$content->mission_image) : 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=1000'); ?>" alt="Mission" class="rounded-2xl shadow-2xl w-full h-[400px] object-cover">
                <div class="absolute -bottom-6 -right-6 bg-red-600 text-white p-8 rounded-2xl shadow-xl hidden md:block">
                    <p class="text-4xl font-bold"><?php echo e($content->experience_years); ?>+</p>
    ...
    <div class="bg-gray-50 dark:bg-gray-800/50 py-16 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <p class="text-4xl font-bold text-red-600 mb-2"><?php echo e($content->stat_cars_sold); ?></p>
                    <p class="text-gray-500 dark:text-gray-400 uppercase tracking-widest text-xs">Cars Sold</p>
                </div>
                <div>
                    <p class="text-4xl font-bold text-red-600 mb-2"><?php echo e($content->stat_happy_clients); ?></p>
                    <p class="text-gray-500 dark:text-gray-400 uppercase tracking-widest text-xs">Happy Clients</p>
                </div>
                <div>
                    <p class="text-4xl font-bold text-red-600 mb-2"><?php echo e($content->stat_partner_dealers); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\thriftmotors\resources\views/pages/about.blade.php ENDPATH**/ ?>